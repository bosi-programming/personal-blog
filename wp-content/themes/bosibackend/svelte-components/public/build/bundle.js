...
var app = (function () {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const click_handler_4 = () => handleCategoryChange(null);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p1 = element("p");
    			t4 = text(t4_value);
    			add_location(h3, file$2, 46, 4, 994);
    			attr_dev(p0, "class", "card-text svelte-ttqf4r");
    			add_location(p0, file$2, 47, 4, 1029);
    			attr_dev(p1, "class", "card-text svelte-ttqf4r");
    			add_location(p1, file$2, 48, 4, 1094);
    ...
    function create_fragment$1(ctx) {
    	...
    	dialog = new Dialog({
    			props: { changeCategory: /*fetchArticles*/ ctx[1] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 32, 0, 1523);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const fetchArticles = (category = null) => __awaiter(void 0, void 0, void 0, function* () {
